    ...
    <div class="bl_blogPage_body bl_blogList bl_1140Inner bl_innerPad">
      <div class="bl_blogList_head">
        <div class="bl_blogCatenav">
          ...
          <!-- <p class="bl_blogCatenav_current"><?= $cat_info->name;  ?></p> -->
        </div>
      </div>
